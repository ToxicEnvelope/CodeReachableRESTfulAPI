...
public class CourseDaoService {
	...
	static {
		courses.add(new Course(1, "Java", "A simple Java course", 0));
		courses.add(new Course(2, "Python", "A simple Python course", 0));
		courses.add(new Course(3, "JavaScript", "A simple JavaScript course", 0));
		courses.add(new Course(4, "DOM", "A simple DOM course", 0));
		courses.add(new Course(5, "Database", "A simple Database course", 0));
	}
