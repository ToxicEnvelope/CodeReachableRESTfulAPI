...
//	static {
//		users.add(new UserV2("1",new Details( new Alias("Adam", "Eden"), new Date(), "adam@yahoo.com")));
//		users.add(new UserV2("2", new Details( new Alias("Eve", "Eden"), new Date(), "eve@facebook.com")));
//		users.add(new UserV2("3", new Details( new Alias("Jack", "Sparro"), new Date(), "jack@live.com")));
//	}
//	
